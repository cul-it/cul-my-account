...
## [2.6.3] - 2026-09-02
### Fixed
- Restored the fix, removed in 2.6.2, that addressed DACCESS-970.

## [2.6.2] - 2026-09-01
### Fixed
- Replaced old progress spinners with Boostrap 5 spinners (DACCESS-963)
- Properly handle filtering out of articles from pending/available requests (DACCESS-1001)

## [2.6.1] - NOOP
- Due to the vagaries of GitHub's tagging and release system, this version doesn't exist.
- That's a shame, because it was the best version ever. Its triumphs will never be matched again.
...
## [2.4.1] 2026-01-08
### Changed
- Require v3.3 of cul-folio-edge to handle update to FOLIO Sunflower

## [2.4] 2025-12-12
### Changed
- Update Rails dependency to v7.0 (DACCESS-639)

## [2.3.9] 2025-10-21
### Added
- (DACCESS-97) Add RSpec tests for most of the Ruby code
